#!/usr/bin/env bash
#SBATCH --job-name=plot_ppc                             # name of job
...
echo "plotting posterior predictions."
...
python3 "$PROJECT_DIR/timepath/plot_posterior_predictions.py" \
    -c $CASE_STUDY -s $SCENARIO -p "*"
